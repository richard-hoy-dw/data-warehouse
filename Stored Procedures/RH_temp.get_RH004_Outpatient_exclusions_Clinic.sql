...
CREATE PROCEDURE [RH_temp].[get_RH004_Outpatient_exclusions_Clinic]
AS
    BEGIN
        SET XACT_ABORT, NOCOUNT ON;

        DROP TABLE IF EXISTS RH_temp.Outpatient_exclusions_Clinic;

        CREATE TABLE [RH_temp].[Outpatient_exclusions_Clinic]
            (
