...
CREATE  PROCEDURE [RH_temp].[get_RH004_Outpatient_exclusions]
AS
    BEGIN
        SET XACT_ABORT, NOCOUNT ON;

        DROP TABLE IF EXISTS RH_temp.RH004_Outpatient_exclusions;

        CREATE TABLE [RH_temp].[RH004_Outpatient_exclusions]
            (
        ...
        INSERT RH_temp.RH004_Outpatient_exclusions
            (
               ...
               WHERE  AD.SourceID          = 'BUR'
                      ...
                      --				OR dP.ServiceID NOT IN ('PHOTO', 'RESEARCH', 'SOCWORK', 'VASCULAR', 'DOC'))
