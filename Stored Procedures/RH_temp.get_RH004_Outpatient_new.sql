...
CREATE  PROCEDURE [RH_temp].[get_RH004_Outpatient_new]
AS
    BEGIN
        SET XACT_ABORT, NOCOUNT ON;

        DROP TABLE IF EXISTS RH_temp.RH004_Outpatient_new;

        CREATE TABLE [RH_temp].[RH004_Outpatient_new]
            (
        ...
        INSERT RH_temp.RH004_Outpatient_new
            (
                source_site
                , source_system
                , attendance_id
               ...
               WHERE  AD.SourceID          = 'BUR'
                      ...
                      AND (dP.ServiceID IS NULL
                      		OR dP.ServiceID NOT IN ('PHOTO', 'RESEARCH', 'SOCWORK'))
