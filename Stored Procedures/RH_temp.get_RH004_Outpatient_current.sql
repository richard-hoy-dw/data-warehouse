...
CREATE  PROCEDURE [RH_temp].[get_RH004_Outpatient_current]
AS
    BEGIN
        SET XACT_ABORT, NOCOUNT ON;

        DROP TABLE IF EXISTS RH_temp.RH004_Outpatient_current;

        CREATE TABLE [RH_temp].[RH004_Outpatient_current]
            (
        ...
        INSERT RH_temp.RH004_Outpatient_current
            (
                source_site
                , source_system
                , attendance_id
			...
			AND (
				dP.ServiceID IS NULL
				OR dP.ServiceID NOT IN (
					'PHOTO',
					'RESEARCH',
					'SOCWORK',
					'VASCULAR',
